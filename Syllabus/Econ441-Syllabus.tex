...
\subsection*{Quizzes}
There will be four in-class quizzes worth equal points (see schedule below). Each quiz will be around 15-20 minutes and will be based on the material and homework questions of the preceding 2-3 weeks. %One quiz with the lowest grade will be dropped while calculating the final grade.  
