...
Problem numbers refer to the textbook (Chiang & Wainwright, 4th edition). These are not graded, but you should attempt them all before the quiz. Each problem has a **Show solution** toggle, and a few have one per part: try it yourself first, then expand to check.
