...
<p>
<a class="btn btn-outline-primary" href="practice-preliminaries.pdf" target="_blank" rel="noopener" aria-label="Practice problems for the Preliminaries module, PDF (opens in a new tab)" role="button">Module problems (PDF)</a>
<a class="btn btn-outline-primary" href="practice-preliminaries_solutions.pdf" target="_blank" rel="noopener" aria-label="Solutions for the Preliminaries module practice problems, PDF (opens in a new tab)" role="button">Module solutions (PDF)</a>
</p>
