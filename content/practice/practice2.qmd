...
**1.** In the following paired statements, let $p$ be the first statement and $q$ the second. Which is true for each case: $p \Rightarrow q$, $p \Leftarrow q$, or $p \Leftrightarrow q$?
   ...
   e. The gasoline tank in my car is empty; I cannot start my car.
   f. The letter is returned to the sender with the marking "addressee unknown"; the sender wrote the wrong address on the envelope.
