...
\begin{document}
\thispagestyle{plain}
\newcommand{\mytitle}{Practice Problems 2}
\myheader{\mytitle}
...
\item [(a)] $\sum_{i=2}^5 x_i$
\item [(b)] $\sum_{i=5}^8 a_i x_i$
\item [(c)] $\sum_{i=1}^4 b x_i$
\item [(d)] $\sum_{i=1}^n a_i x^{i-1}$
\item [(e)] $\sum_{i=0}^3(x+i)^2$ \\
\end{enumerate}
\end{multicols}
