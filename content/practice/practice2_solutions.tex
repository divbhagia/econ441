...
\item $\begin{aligned} y = 16 + 2x, \quad  f^{-1}(y) = \frac{y-16}{2} \end{aligned}$ 

\vspace{1em}

\tagstructbegin{tag=Figure,alt={Graph of the straight line y equals 16 plus 2x, an upward-sloping line crossing the y-axis at 16}}\tagmcbegin{}
...
\end{tikzpicture}
\tagmcend\tagstructend
\item $ \begin{aligned} y = 8-2x \quad  f^{-1}(y) = \frac{8-y}{2}\end{aligned}$ 

\vspace{1em}

\tagstructbegin{tag=Figure,alt={Graph of the straight line y equals 8 minus 2x, a downward-sloping line crossing the y-axis at 8}}\tagmcbegin{}
\begin{tikzpicture}[scale=0.85]
...
\end{tikzpicture}
\tagmcend\tagstructend
\item $\begin{aligned} y = 2x+12 \quad  f^{-1}(y) = \frac{y-12}{2}\end{aligned}$ 

\vspace{1em}

\tagstructbegin{tag=Figure,alt={Graph of the straight line y equals 2x plus 12, an upward-sloping line crossing the y-axis at 12}}\tagmcbegin{}
\begin{tikzpicture}[scale=0.85]
