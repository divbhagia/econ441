...
\[
\begin{aligned}
& x^T A x=\left[\begin{array}{ll}x_{1} & x_{2}\end{array}\right]\left[\begin{array}{cc}a_{11} & 0 \\0 & a_{22}\end{array}\right]\left[\begin{array}{l}x_{1} \\x_{2}\end{array}\right]_{2 \times 1} \\
...
So $x^T A x$ represents a weighted sum of squares where $a_{11}, a_{22}$ are weights.\\
...
So $x^T A x$ no longer represents a weighted sum of squares. \\

You can check that the associative law i.e.
\[
\left(x^T A\right) x=x^T(A x)
\]
...
\item $ \begin{aligned} x^T I=\left[\begin{array}{ll}x_{1} & x_{2}\end{array}\right]\left[\begin{array}{ll}1 & 0 \\ 0 & 1\end{array}\right]_{2 \times 2}=\left[\begin{array}{ll}x_{1} & x_{2}\end{array}\right]\end{aligned}$ \\~\\
\end{enumerate}
...
\( A^T+B^T=\left[\begin{array}{rr}0 & -1 \\ 4 & 3\end{array}\right]+\left[\begin{array}{cc}3 & 0 \\ -8 & 1\end{array}\right]=\left[\begin{array}{cc}3 & -1 \\ -4 & 4\end{array}\right] \) \\~\\
So, \((A+B)^T=A^T+B^T\) \\
...
% Question 6
\item[6.] \( A=I-X\left(X^T X\right)^{-1} X^T \) 
