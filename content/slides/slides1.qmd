...
![](../../assets/venn2.svg){fig-alt="Blank two-set Venn diagram: sets A and B overlapping inside universal set U" width=280}
:::
::: {.column width="33%"}
$A \cap B$
...
![](../../assets/venn3.svg){fig-alt="Blank three-set Venn diagram for shading the region A: sets A, B, and C overlapping inside universal set U" width=300}
:::
::: {.column width="50%"}
$B \cap C$

![](../../assets/venn3.svg){fig-alt="Blank three-set Venn diagram for shading the region B intersect C: sets A, B, and C overlapping inside universal set U" width=300}
:::
:::
...
![](../../assets/venn3.svg){fig-alt="Blank three-set Venn diagram for shading the region A union B: sets A, B, and C overlapping inside universal set U" width=300}
:::
::: {.column width="50%"}
$A \cup C$

![](../../assets/venn3.svg){fig-alt="Blank three-set Venn diagram for shading the region A union C: sets A, B, and C overlapping inside universal set U" width=300}
:::
:::
