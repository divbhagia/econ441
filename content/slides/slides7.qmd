...
A homogeneous equation system is given by $$Ax = 0$$
...
![](../../assets/fig/stem-linal.png){fig-alt="Comic showing a precarious tower of blocks labeled 'All of STEM' balancing on one small block labeled 'That one linear algebra course'" width=430}
