...
```{python}
#| fig-alt: "Line plot of y equals x cubed, increasing steeply from 0 to 125 as x goes from 0 to 5"
...
```{python}
#| fig-alt: "Line plot comparing y equals x cubed and z equals x squared for x from 0 to 5, with a legend; the cubic curve rises much faster"
