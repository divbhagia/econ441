...
```{python}
#| fig-alt: "Downward-sloping demand curve for good 1, with demand falling as the price of good 1 rises"
...
```{python}
#| fig-alt: "Two downward-sloping demand curves for good 1, with the m equals 200 curve lying above the m equals 100 curve"
...
```{python}
#| fig-alt: "Demand for good 1 slopes downward in its own price while demand for good 2 stays flat, since demands depend only on own price under Cobb-Douglas preferences"
