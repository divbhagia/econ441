...
LECTURES = {
 ...
 dt.date(YEAR,9,14):  (6,"Linear independence and rank; computing the determinant","5.1-5.3",[("Handout-Determinant-and-Inverse.pdf","Determinant and Inverse")]),
 dt.date(YEAR,9,16):  (7,"Solving systems of linear equations: inversion, Cramer's rule; applications","5.4, 5.5, 4.7",[("Handout-Solving-System-of-Equations.pdf","Solving Systems of Equations")]),
